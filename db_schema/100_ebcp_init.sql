...
insert into o_ebcp_exhibition_item (
    ...
    md5('IOC大屏监控'), md5('IOC一层监控厅'), 'static', 'power', 0, '[{"name":"一键开启","type":"start","command":"FB 01 01"},{"name":"一键关闭","type":"stop","command":"FB 01 02"},{"name":"灯光全开","type":"start","command":"FB 01 03"},{"name":"灯光全关","type":"stop","command":"FB 01 04"}]','192.168.10.108',33333);

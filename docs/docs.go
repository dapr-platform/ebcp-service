...
const docTemplate = `{
    ...
    "paths": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.Ebcp_exhibition_floor_info"
                                            }
                                        }
                                    }
                                }
        ...
        "/ebcp-exhibition-floor-info/page": {
            "get": {
                "description": "page query, _page(from 1 begin), _page_size, _order, and others fields, status=1, name=$like.%CAM%",
                "produces": [
                    "application/json"
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/common.PageGeneric-model_Ebcp_exhibition_floor_info"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "common.PageGeneric-model_Ebcp_exhibition_floor_info": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
        ...
        "model.Ebcp_exhibition_floor_info": {
            "type": "object",
            "properties": {
                "id": {
                    "description": "id",

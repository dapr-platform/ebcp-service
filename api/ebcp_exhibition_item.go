...
func InitEbcp_exhibition_itemRoute(r chi.Router) {
	...
	r.Get(common.BASE_CONTEXT+"/ebcp-exhibition-item/groupby", Ebcp_exhibition_itemGroupbyHandler)
}

// @Summary GroupBy
// @Description GroupBy, for example,  _select=level, then return  {level_val1:sum1,level_val2:sum2}, _where can input status=0
// @Tags Ebcp_exhibition_item
// @Param _select query string true "_select"
// @Param _where query string false "_where"
// @Produce  json
// @Success 200 {object} common.Response{data=[]map[string]any} "objects array"
// @Failure 500 {object} common.Response ""
// @Router /ebcp-exhibition-item/groupby [get]
func Ebcp_exhibition_itemGroupbyHandler(w http.ResponseWriter, r *http.Request) {

	common.CommonGroupby(w, r, common.GetDaprClient(), "o_ebcp_exhibition_item")
}
...
func batchUpsertEbcp_exhibition_itemHandler(w http.ResponseWriter, r *http.Request) {
	...
	err = common.DbBatchUpsert[map[string]any](r.Context(), common.GetDaprClient(), entities, model.Ebcp_exhibition_itemTableInfo.Name, model.Ebcp_exhibition_item_FIELD_NAME_id)
	if err != nil {
